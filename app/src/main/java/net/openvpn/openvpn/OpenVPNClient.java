...
public class OpenVPNClient extends OpenVPNClientBase implements OnRequestPermissionsResultCallback, OnClickListener, OnTouchListener, OnItemSelectedListener, OnEditorActionListener {
    ...
    private Spinner profile_spin, network_spinner;
...
//###################################################################################################################
		...
		//LIST
		network_spinner=(Spinner)findViewById(R.id.network);

		adapter1=new ArrayAdapter<String>(this, android.R.layout.simple_dropdown_item_1line,list1);
		adapter1.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
		network_spinner.setAdapter(adapter1);

		network_spinner.setOnItemSelectedListener(new OnItemSelectedListener(){
				...
				private void add(){
					...
					switch(a)
					{
						case 0:
							...
							profile_spin.setAdapter(adapter2);
				...
				private void select(){
					...
					profile_spin.setOnItemSelectedListener(new OnItemSelectedListener(){
							@Override
							public void onItemSelected(AdapterView<?>arg0, View arg1,
													   int arg2, long arg3){
								//TODO Auto-generated method stub
								a = profile_spin.getSelectedItemPosition();
							}
							@Override
				...
				public boolean onNavigationItemSelected(MenuItem menuItem) {
					...
					switch (id){
						case R.id.cupdate:
							...
							return true;
						case R.id.settings:
							Intent MyIntent1= new Intent(OpenVPNClient.this,OpenVPNLog.class);
							startActivity(MyIntent1);
							Toast.makeText(getApplicationContext(),"Settings",Toast.LENGTH_SHORT).show();
							break;
						case R.id.trash:
							Intent MyIntent2= new Intent(OpenVPNClient.this,OpenVPNLog.class);
							startActivity(MyIntent2);
							Toast.makeText(getApplicationContext(),"Trash",Toast.LENGTH_SHORT).show();
							drawerLayout.closeDrawers();
							break;
						case R.id.logout:
							Intent MyIntent3= new Intent(OpenVPNClient.this,OpenVPNLog.class);
							startActivity(MyIntent3);
							finish();
						case R.id.exit_partial /*2131361953*/:
							finish();
							return true;
						case R.id.exit_full /*2131361954*/:
							finish();
							break;
					}
					return true;
